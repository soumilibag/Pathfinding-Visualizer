...
import recursiveDivision from "../lib/algorithms/maze/recursiveDivison";
...
// Run the selected maze generation algorithm based on the provided maze type
export const runMazeAlgorithm = async ({
  ...
  if (maze == "BINARY_TREE") { // Run the binary tree maze generation algorithm
    await binaryTree(grid, startTile, endTile, setIsDisabled, speed);
  }
  else if (maze === "RECURSIVE_DIVISION") { // Run the recursive division maze generation algorithm
